...
var sendTxCtrl = function($scope, $sce, walletService, $rootScope) {
    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                var checkTxLink = "https://explorer.etherzero.org/tx/" + resp.data;
                ...
                var msg = "Your TX has been broadcast to the network. This does not mean it has been mined & sent. During times of extreme volume, it may take 3+ hours to send. 1) Check your TX below. 2) Save your TX Hash in case you need it later:";
                // var completeMsg = '<p>' + globalFuncs.successMsgs[2] + '<strong>' + resp.data + '</strong></p><p>' + verifyTxBtn + ' ' + checkTxBtn + '</p>';
                var completeMsg = '<p>' + msg + '<strong>' + resp.data + '</strong></p><p>' + verifyTxBtn + ' ' + checkTxBtn + '</p>';
