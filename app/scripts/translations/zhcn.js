...
ONBOARD_blockchain_content__5   :  '当你使用 MyEtherWallet.com 查看余额, 或者使用 [etherscan.io](https://etzscan.com)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : '这允许你下载不同格式的私钥和重新打印你的纸钱包。为了将[你的账户导入到Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)，你可能需要这个操作。如果你想查看你的余额，我们推荐使用区块浏览器，例如[etherscan.io](https://etzscan.com/)。 ',
