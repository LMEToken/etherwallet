...
ONBOARD_blockchain_content__5   :  'MyEtherWalletや[etherscan.io](https://etzscan.com)で残高や処理を見た時、見えるのは私たちのシステムの中ではなく、ブロックチェーンにあるデータです。', /*When you see your balance on MyEtherWallet.com or view your transactions on [etherscan.io](https://etzscan.com), you are seeing data on the blockchain, not in our personal systems.*/
...
PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションがすでにインポートされています。 A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [etherscan.io](https://etzscan.com) & wait 10 minutes before attempting to send again. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
TranslatorAddr_4            : '',
TranslatorAddr_5            : '',
TranslatorName_1            : '[sekisanchi.eth](https://etzscan.com/addr/0xf991119eea62eee1a6fdaa7f621e91a42f325fce) ', /* Translator 1: Kazunori Seki / 関一典 */
...
VIEWWALLET_Subtitle         : '異なったバージョンの秘密鍵をダウンロードしたり、お財布紙情報を再印刷することができます。[import your account into Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)する時に必要です。残高をチェックするためには、[etherscan.io](https://etzscan.com/)のようなブロックチェーンエクスプローラーサービスを使う事をおすすめします。 ',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [etherscan.io](https://etzscan.com/). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://etzscan.com/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on etherscan.io ',
