...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Esto te permite descargar múltiples versiones de claves privadas e imprimir de nuevo tu cartera en papel. Puede que te interese hacer esto para [importar tu cuenta en Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si quieres comprobar tu saldo, recomendamos utilizar un explorador de blockchain como [etherscan.io](https://etzscan.com/). ',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [etherscan.io](https://etzscan.com/). Paste your address into the search bar and it will pull up your account and transaction history. For example, here\'s what our [donation account](https://etzscan.com/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on etherscan.io ',
