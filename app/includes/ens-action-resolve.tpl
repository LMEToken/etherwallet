<article class="col-xs-12 col-sm-10 col-sm-offset-1" ng-show="objENS.status==ensModes.owned && objENS.owner==objENS.deedOwner && wd">
  ...
  <div class="form-group" style="margin: 2em auto;">
    ...
    <ol>
      ...
      <li>
        <a href="https://explorer.etherzero.org/tx/0x60eec50b492375bce25684f806599873b7f682e1ba504c8bed7cc90c33368118"
           target="_blank"
  ...
  <div class="form-group" style="margin: 2em auto;">
    ...
    <ol>
      ...
      <li>
        <a href="https://explorer.etherzero.org/tx/0xe4b8cbbb9c30a9066e4d430e347e07442ccc99b927ed73280792aee718ecbd30"
           target="_blank"
           rel="noopener noreferrer">
              TX should look like this.
        </a>
