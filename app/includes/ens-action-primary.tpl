  ...
  <article class="row">
    ...
    <section class="col-sm-8">
      ...
      <div class="form-group well" ng-show="objENS.txSent && (objENS.status==ensModes.auction || objENS.status==ensModes.open)">
        ...
        <p>Please check your address on <a href="https://explorer.etherzero.org/">https://explorer.etherzero.org/</a> to ensure your BID TX is on the blockchain, without errors.</p>
