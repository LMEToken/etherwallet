        ...
        <table class="table small table-condensed table-hover">
          <tbody>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.value}} ETZ</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.gasPrice.gwei}} GWEI <small>({{parsedSignedTx.gasPrice.eth}} ETZ)</small>
              </td>
            </tr>
            <tr>
              <td class="small text-right">Max TX Fee:</td>
              <td class="small text-left mono"> {{parsedSignedTx.txFee.eth}} ETZ <small>({{parsedSignedTx.txFee.gwei}} GWEI)</small></td>
            </tr>
            <tr>
